...
def main():
    ...
    NAV = os.path.join(base, "ECAC_nav.txt")
    SEG = os.path.join(base, "ECAC_seg.txt")
    AER = os.path.join(base, "ECAC_aer.txt")

    # Carga del espacio aéreo de Europa (ECAC)
    aspace = AirSpace()
    ...
    # Exportar a KML
    out = os.path.join(base, "espacio_europa.kml")
    graph_to_kml(g, out)
